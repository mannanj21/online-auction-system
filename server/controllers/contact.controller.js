...
export const handleSendMessage = async (req, res) => {
  try {
    ...
    await resend.batch.send([
      ...
      {
        from: `Your Name <hi@yourdomain.com>`,
        to: email,
        subject: `Reply from Your Name`,
  ...
  <html lang="en" style="margin: 0; padding: 0;">
    ...
    <body>
      <div class="container">
        ...
        <a href="https://your-app-domain.com" class="btn">Visit Our Website</a>
        ...
        <div class="footer">
          &copy; 2025 Online Auction (Your Name). All rights reserved. <br />
